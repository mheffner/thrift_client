...
Gem::Specification.new do |s|
  ...
  s.test_files = [%q{test/thrift_client_http_test.rb}, %q{test/test_helper.rb}, %q{test/simple_test.rb}, %q{test/thrift_client_test.rb}, %q{test/multiple_working_servers_test.rb}]
